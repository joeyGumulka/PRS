...
LRU: The page at index 0 is evicted. The algorithm maintains recency by moving recently accessed (“hit”) pages to the end of the array, ensuring that the least recently used page shifts to index 0 and is selected for eviction in tie situations.
